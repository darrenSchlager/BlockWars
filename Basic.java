/*  this version is cleaner, just uses a JFrame, make application
    programmer responsible for setting cameras so some of the drawing 
    doesn't disappear under the title bar!
*/
